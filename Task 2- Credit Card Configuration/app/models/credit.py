...
class BureauReport(Base):
    ...
    application = relationship("CreditCardApplication", backref="bureau_report", uselist=False)
...
class RiskAssessment(Base):
    ...
    application = relationship("CreditCardApplication", backref="risk_assessment", uselist=False)
